    ...
    <div className="space-y-6 max-w-md">
      ...
      <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-2xl bg-[#111] flex items-center justify-center shrink-0 shadow-lg overflow-hidden">
            <img src="/logo.png" alt="MIMATE OS" className="w-full h-full object-contain p-2" />
          </div>
          <div className="flex-1">
            <p className="text-gray-900 font-bold text-lg">MIMATE OS</p>
      ...
      {status === STATUS.UP_TO_DATE && (
        <div className="text-center py-4 space-y-1">
          <p className="text-gray-700 font-medium text-sm">MIMATE OS is up‑to‑date</p>
      ...
      {status === STATUS.AVAILABLE && (
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5 space-y-4">
          <div>
            ...
            <p className="text-blue-600 text-xs mt-1">Er is een nieuwe versie van MIMATE OS beschikbaar. De update duurt ongeveer 2 minuten.</p>
          </div>
