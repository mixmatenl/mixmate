...
export default function CloudPairing({ onClose }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: '#f2f2f2', display: 'flex', flexDirection: 'column', ...s }}>
      {/* Header */}
      <div style={{ background: '#fff', borderBottom: '1px solid #e5e7eb', padding: '16px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ fontSize: 17, fontWeight: 600 }}>Cloud koppeling</div>
        <button onClick={onClose} style={{ background: '#f3f4f6', border: 'none', color: '#111', width: 36, height: 36, borderRadius: 18, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
