...
_NAME_MAP = {
    # Naam in seed          → zoekterm TheCocktailDB
    ...
    "Mango Tango":          "Mango",
    "Rosé Lemonade":        "Lemonade",
    "Cucumber Cooler":      "Gin and Tonic",
    "Coconut Kiss":         "Pina Colada",
    "Caribbean Breeze":     "Bay Breeze",
    "Malibu Sunset":        "Tequila Sunrise",
    "Bay Breeze":           "Bay Breeze",
    "Blue Motorcycle":      "Blue Lagoon",
    "Jungle Juice":         "Sex on the Beach",
    "Sangria Punch":        "Sangria",
    "Vodka Redbull":        "Vodka Red Bull",
    "Grapefruit Gin":       "Greyhound",
    "Tropical Punch":       "Bahama Mama",
    "Bahama Mama":          "Bahama Mama",
    "Appletini":            "Appletini",
    "Campari Orange":       "Negroni",
    "Cognac Sour":          "Whiskey Sour",
