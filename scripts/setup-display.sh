...
Type=Application
Name=Mixmate
Exec=chromium --kiosk --noerrdialogs --disable-infobars --no-first-run --password-store=basic --disable-translate --force-device-scale-factor=1.5 http://localhost:8000
X-GNOME-Autostart-enabled=true
EOF
